...
class BufferManager(Int32 totalBytes, Int32 totalBufferBytesInEachSaeaObject) {
    ...
    Int32 totalBytesInBufferBlock = totalBytes;

    // Byte array maintained by the Buffer Manager.
    byte[]? bufferBlock;
    Stack<int> freeIndexPool = new Stack<int>();
    Int32 currentIndex = 0;
    Int32 bufferBytesAllocatedForEachSaea = totalBufferBytesInEachSaeaObject;
